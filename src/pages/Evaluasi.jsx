...
function Evaluasi() {
    ...
    const newResult = localStorage.getItem('laraseft_evaluasi');

    const laraseftId = localStorage.getItem('laraseftId');

    useEffect(() => {
        try {
            const historyString = localStorage.getItem("evaluasiHistory");
            if (historyString) {
    ...
    const handleSubmit = async () => {
        ...
        setResult(result);
        localStorage.setItem("laraseft_evaluasi", result);
        ...
        localStorage.setItem('evaluasiHistory', JSON.stringify(resultToSave));
    };
        ...
        <div>
            <div className="my-0 mx-auto min-h-full max-w-screen-sm bg-white">
                <div className="border-b-2 border-gray-400">
                    <h2 className="text-xl font-bold px-4 py-4">Evaluasi</h2>
                </div>
                ...
                <div className="px-4 py-6 mb-20">
                    ...
                    <div className="py-10">
                        <h3 className="text-lg font-bold">Hasil evaluasi: {result}</h3>
                    </div>
                </div>
            </div>
        </div>
