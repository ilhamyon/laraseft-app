        ...
        const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
          ...
          body: JSON.stringify({
            mutations: [
              {
                create: {
                  _type: 'laraseft-tekanandarah', // Ganti dengan jenis dokumen pengguna di Sanity Anda
                  user: {
                    _type: 'reference',
        ...
        const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
          ...
          body: JSON.stringify({
            mutations: [
              {
                create: {
                  _type: 'laraseft-guladarah', // Ganti dengan jenis dokumen pengguna di Sanity Anda
                  user: {
                    _type: 'reference',
                    _ref: laraseftId // Assuming userData.userId contains the ID of the user document
                  },
        ...
        const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
          ...
          body: JSON.stringify({
            mutations: [
              {
                create: {
                  _type: 'laraseft-imt', // Ganti dengan jenis dokumen pengguna di Sanity Anda
                  user: {
                    _type: 'reference',
                    _ref: laraseftId // Assuming userData.userId contains the ID of the user document
                  },
            ...
            <Collapse defaultActiveKey={['1']}>
              <Collapse.Panel header="Tekanan Darah" key="1">
                <div className="py-6">
                  ...
                  {/* <h2 className="font-bold text-[18px] lg:text-4xl mb-10 text-gray-900 uppercase">Biodata <br/><span className="text-xl">({laraseftData[0]?.name})</span></h2> */}
                    <DatePicker
                      name="date"
